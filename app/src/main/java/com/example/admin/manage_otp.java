    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verify_otp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(manage_otp.this,"Empty Field",Toast.LENGTH_SHORT).show();
                }
                else if(otp.getText().toString().length()!=6)
                {
                    Toast.makeText(manage_otp.this,"Invalid OTP",Toast.LENGTH_SHORT).show();
                }
                else
                {
                ...
                PhoneAuthOptions options = PhoneAuthOptions.newBuilder(auth)
                        ...
                        .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull @NotNull FirebaseException e) {
                                Toast.makeText(manage_otp.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                            }
                            })
                        .build();
        ...
        auth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull @NotNull Task<AuthResult> task) {
                if(task.isSuccessful()) {
                    Intent i=new Intent(manage_otp.this,MainActivity.class);
                    i.putExtra("user_mobile_no",no);
                    startActivity(i);
                }
                else
                {
                    Toast.makeText(manage_otp.this,"SignIn code Error",Toast.LENGTH_SHORT).show();
                }
            }
        });
  }
